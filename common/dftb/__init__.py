...
def add_dftb_arguments(parser, calc_type):
    """Add DFTB-specific command line arguments to the parser.

    Args:
        parser: ArgumentParser instance to add arguments to
        calc_type: Type of calculation ('scf', 'opt', 'band', 'eos', 'neb')
    """
    if calc_type == "opt":
    ...
    parser.add_argument(
        "-np", dest="nproc", default=N_PROCESS, type=int, required=False, help=msg
    )
    ...
    parser.add_argument(
        "--pol-rep", dest="pol_rep", action="store_true", default=False, help=msg
    )
    ...
    if calc_type == "band":
        ...
        parser.add_argument(
            "--emin", dest="emin", default=E_MIN, type=float, required=False, help=msg
        )

        msg = "E max for the band structure plotting"
        parser.add_argument(
            "--emax", dest="emax", default=E_MAX, type=float, required=False, help=msg
        )
...
def get_args(args: dict, calc_type: str) -> dict:
    """Process and validate command line arguments for DFTB calculations.
